      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-bgColor shadow-default">
        <div className="relative z-20 h-35 md:h-65">
          ...
          <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
            <label
              htmlFor="cover"
              className="flex cursor-pointer items-center justify-center gap-2 rounded bg-primary py-1 px-2 text-sm font-medium text-textColor hover:bg-opacity-90 xsm:px-4"
            >
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-bgColor/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
          ...
          <div className="mt-4">
            <h3 className="mb-1.5 text-2xl font-semibold text-textColor">
              Danish Heilium
            </h3>
            <p className="font-medium text-textColor">Ui/Ux Designer</p>
            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 bg-bgColor text-textColor">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 xsm:flex-row">
                <span className="font-semibold text-textColor">259</span>
                <span className="text-sm text-textColor">Posts</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 xsm:flex-row">
                <span className="font-semibold text-textColor">129K</span>
                <span className="text-sm">Followers</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                <span className="font-semibold text-textColor">2K</span>
                <span className="text-sm">Following</span>
              </div>
            </div>

            <div className="mx-auto max-w-180">
              <h4 className="font-semibold text-textColor">About Me</h4>
              <p className="mt-4.5 text-textColor">
            ...
            <div className="mt-6.5">
              <h4 className="mb-3.5 font-medium text-textColor">
                Follow me on
              </h4>
